Feature: Manage Producers
	In order to sell headers
	As a product administrator
	I Want to manage headers
	...
	Scenario: Create Producer
	    ...
	    Then I should see "Header '001' was created"
